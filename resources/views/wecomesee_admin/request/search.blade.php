            ...
            <tbody>
                    @if(!empty($data_request))
                        ...
                        <tr>
                            ...
                            <td>@if ($data->flag == 'P')
                                <a href="{{ route('data_request.terima', $data->id) }}" class="btn btn-success btn-sm">Terima</a>
                                <a href="{{ route('data_request.tolak', $data->id) }}" class="btn btn-danger btn-sm">Tolak</a>
                                @elseif ($data->flag == 'N')
